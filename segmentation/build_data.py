...
class ImageReader(object):
    ...
    def __init__(self, image_data, image_format='jpg', channels=3):
        """Class constructor.
        Args:
        ...
        if self._image_format == 'jpg':
            self._decode = tf.image.decode_jpeg(image_data, channels=channels)
        elif self._image_format == 'png':
            self._decode = tf.image.decode_png(image_data, channels=channels)

    def read_image_dims(self):
